		...
		while(true) { //무한반복
			...
			case 1:
				for(;;) {
					...
					System.out.println("한식메뉴를 선택하세요. (한식메뉴 선택종료:0, 전체종료:99)");
					tmp = scanner.next();
			...
			case 2 :
				for(;;) {
					...
					System.out.println("양식메뉴를 선택하세요. (양식메뉴 선택종료:0, 전체종료:99)");
			...
			case 3 :
				for(;;) {
					...
					System.out.println("중식메뉴를 선택하세요. (중식메뉴 선택종료:0, 전체종료:99)");
