...
// 게임 및 다양한 그래픽을 구사할 수 있다. 현재는 HTML5등 웹이 진화되면서 거의 사라져감.
// 라이프사이클을 가지고 있다. init() - start() - stop()-destroy()
//init()은 필수처리이며 나머지는 자동으로 처리되며 특정 웹브라우저의 페이지 이동 및 강제 종료시킬때 간혹 쓰인다.
public class StringLine extends JApplet{
	...
	public void paint(Graphics g) {
		...
		g.drawLine(105, 50, 30, 160); //선그리기 drawLine(x1,y1,x2,y2)
